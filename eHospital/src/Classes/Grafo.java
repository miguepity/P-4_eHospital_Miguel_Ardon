...
public class Grafo{
    ...
    public DistanceMatrix getfloyd(){
       DistanceMatrix matrix = g.floydWarshallAlgorithm.compute(g);
        System.out.println(g.floydWarshallAlgorithm.compute(g).array.length);
        return matrix;
    }
    ...
    public SearchResult[] algo() {
    SearchResult[] array = g.bellmanFordAlgorithm.compute(g);
    return array;
}
}
